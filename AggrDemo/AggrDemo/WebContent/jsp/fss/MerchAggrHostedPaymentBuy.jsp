...
try 
{
System.out.println("MerchAggrHostedPaymentBuy.jsp  called....");
Random rnd = new Random(System.currentTimeMillis());
String comment = request.getParameter("comment");
String action = request.getParameter("action");  // 1 - Purchase
...
pipe.setCustAcctNo(accountnumber); //Customer Account Number for Internet Banking ->Added By Sudharsan
