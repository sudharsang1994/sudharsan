...
<%@page import="com.fss.plugin.NotificationPipe"%>
			...
			<div class="col-md-12 cart-items" style="min-height: 550px;">
				...
				<div>
					<TABLE align=left border="0">
						...
						String invoiceid=String.valueOf(Math.abs(rnd.nextInt()));
						String tranportalID ="";
						String tranportalPW ="";
						...
						File usersFile = new File(basePath+"/WEB-INF/", "merchant_notification.txt");
					...
					/* 	String cvv    = request.getParameter("cvv");
						...
						while ((str = br.readLine()) != null) {
							...
							/* 	if ( str.substring(0,str.indexOf("=")) .equals("merchant.receiptURL") )
								...
								if ( str.substring(0,str.indexOf("=")) .equals("aggr.notifywebaddr") )
						...
						pipe.setTranpassword(tranportalPW);
						...
						pipe.setEmail(email);
						pipe.setMobnum(mobnum);
						pipe.setInvoiceid(invoiceid);
						pipe.setExpirydate(expirydate);
						pipe.setCustomername(customername);
						...
						<TR>
							...
							<TD class="text1">
								<% if((pipe.getSmsstatus().equals("SUCCESS")&& pipe.getEmailstatus().equals("SUCCESS")) || pipe.getSmsstatus().equals("SUCCESS") || pipe.getEmailstatus().equals("SUCCESS"))
										{
										%> <%=pipe.getResult() %> &nbsp; 
							</TD>
						</TR>
						...
						<TR>
							<TD class="text1">Please note your <span class="textblue">
									Track ID : <%=pipe.getTrackid()%></span> <%System.out.println("pipe.getTrackid() :"+pipe.getTrackid()+"pipe.getPaymentId() :"+pipe.getPaymentId()); %>
